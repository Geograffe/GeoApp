...
from api.openweathermap import get_weather_data, get_forecast_data
...
def main():
    ...
    create_map_with_features(lat, lon, lang_prompts['weather_prompt'], dengue_clusters, [], polygon_data, user_location)

    # Display dengue warning based on clusters
    if dengue_clusters:
    ...
    if 'selected_coords' in st.session_state:
        ...
        if route_type == "public transport":
            ...
            if public_transport_route:
                ...
                if route_geometry:
                    create_map_with_features(lat, lon, lang_prompts['weather_prompt'], dengue_clusters, [], polygon_data, user_location, route_geometry)
            else:
            ...
            if st.button(lang_prompts['return_home_btn'], key="return_home_btn"):
                ...
                if route_type == "public transport":
                    ...
                    if route_data and "route_geometry" in route_data:
                        ...
                        create_map_with_features(lat, lon, lang_prompts['weather_prompt'], dengue_clusters, theme_data, polygon_data, user_location, route_geometry)
